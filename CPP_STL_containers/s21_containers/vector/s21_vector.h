#ifndef S21_CPP_CONTAINERS_VECTOR_H_
#define S21_CPP_CONTAINERS_VECTOR_H_
...
class vector {
 public:
  ...
  using const_iterator = vector<T>::ConstVectorIterator;
...
#endif  // S21_CPP_CONTAINERS_VECTOR_H_